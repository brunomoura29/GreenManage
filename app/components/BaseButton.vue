<template>
  <button
    ...
    :class="[
      ...
      'active:scale-95 disabled:scale-100 disabled:opacity-60 disabled:cursor-not-allowed',
      block ? 'w-full' : '',
      sizeClasses[size],
...
const variantClasses = {
  primary: 'bg-primary hover:bg-primary-600 text-white shadow-sm shadow-primary/30',
  secondary: 'bg-secondary hover:bg-secondary-600 text-white shadow-sm shadow-secondary/30',

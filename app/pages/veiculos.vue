<template>
  <div class="min-h-full">
    <!-- Header -->
    <div v-if="view === 'lista'" class="px-6 md:px-8 pt-8 pb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 animate-in fade-in duration-500">
      <div>
    ...
    <!-- Conteúdo Dinâmico (Lista ou Cadastro) -->
    <div v-if="view === 'lista'" class="animate-in fade-in duration-500">
      <!-- Barra de pesquisa -->
